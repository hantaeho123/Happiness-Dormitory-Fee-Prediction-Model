...
dt<-read.csv(file="D:/바탕화면사항/대학 과제/4학년_2학기/수학창의연구(캡스톤)/주제책정(행복기숙사)조사/최종행복기숙사비데이터.csv")
ajouex<-read.csv(file="D:/바탕화면사항/대학 과제/4학년_2학기/수학창의연구(캡스톤)/주제책정(행복기숙사)조사/아주대데이터.csv")
```
